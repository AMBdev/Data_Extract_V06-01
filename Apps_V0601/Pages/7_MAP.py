...
st.header("Description du Trajet")
st.title("Usage général des fonctions ADAS")
...
def Trace_LC():
    ...
    dict_color={'Cancel':'red','LCA_Active':'lightblue','LCA_Off':'black','Safe_State':'gray','Temporary_Cancel':'ligtgray'}
...
Carte1 = folium.Map(location=[lat0,lon0],zoom_start = 6)
